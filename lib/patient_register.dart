...
class _PatientRegisterScreenState extends State<PatientRegisterScreen> {
  ...
  // ✅ UPDATED FUNCTION (FIRESTORE INTEGRATION)
  Future<void> _register() async {
    if (_firstNameCtrl.text.trim().isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
              'Please fill First Name, Mobile and Aadhaar fields'),
        ),
      );
      return;
    }
    ...
    try {
      ...
      await firestore.addPatient(
        firstName: AppData.patientFirstName,
        lastName: AppData.patientLastName,
        mobile: AppData.patientMobile,
        aadhaar: AppData.patientAadhaar,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _field(
              translations[lang]!['location_village']!,
              _locationCtrl,
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: _register,
                child: Text(
                  translations[lang]!['verify_register']!,
